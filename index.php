    ...
    <main class="container-fluid"> 
        <div class="col-6 m-auto pt-4">
            <form action="rusults.php" method="GET">
                <textarea class="w-100 p-2 border border-0 rounded-3" name="paragrafoUtente" id="paragrafoUtente" cols="30" rows="6" placeholder="Scrivi una frase a caso, tipo: non ci sono più le mezze stagioni, brutto st***zo!"></textarea>
                <div>
                    <label class="text-white p-2" for="parola">Scrivi parola da censurare: </label>
                    <input class="w-100 p-2 border border-0 rounded-3" name="parola" id="parolaDaCensurare" type="text" placeholder="st***zo!">
                </div>
